...
- **Ouverture / fermeture datée** (`ligne`/`poste`, migration 0071, helper
  ...
  Ordonnancement** (les **Bilans ne filtrent PAS encore** par date). UI : dates
...
- Référentiel : `src/app/admin/referentiel/*` + `src/app/api/referentiel/route.ts`
  ...
  **effectif par quart** et **Ferme le**).
  ...
  aujourd'hui dans Planning/Placement/Ordonnancement (pas les Bilans). L'`updateTable`
...
- Migrations : `supabase/migrations/0001..0071` (dernière appliquée : **0071** —
  ...
  Placement / Ordonnancement (pas encore les Bilans). UI : dates Ouvre/Ferme + badge
