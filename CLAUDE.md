...
- Migrations : `supabase/migrations/0001..0063` (dernière appliquée : **0062**,
  `site.seuil_competent` — seuil « compétent » paramétrable par site ; `0061` =
  `site.nb_niveaux`, nombre de niveaux activés par site).
  **0063 écrite, à appliquer** : `competence_niveau_libelle.couleur` (couleur par niveau).
