...
- Migrations : `supabase/migrations/0001..0061` (dernière appliquée : **0060**,
  `motif_absence.non_planifie` — classification planifié/non planifié des absences).
  **0061 écrite, à appliquer** : `site.nb_niveaux` (nombre de niveaux activés par site).
