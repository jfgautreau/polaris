    ...
    <>
      ...
      <div className="container" style={{ maxWidth: 1500 }}>
        ...
        <div className="kpi-grid">
          ...
          <div className={`kpi ${r.nbClesPartantes > 0 ? "danger" : "ok"}`}><div className="v">{r.nbClesPartantes}</div><div className="l">Personnes clés partantes</div><div className="s">seule à tenir un poste · ≤ {H_DEPART} j</div></div>
