...
export const RAPPORTS_BILAN: RapportBilan[] = [
  ...
  { key: "bilan:feuille-route", slug: "feuille-route", href: "/bilans/feuille-route", ic: "🗺️", t: "Projection de compétences — feuille de route", d: "Sur 24 semaines : nombre de personnes par service, catégorie et niveau exact (MAX par catégorie), avec Besoin (abaque) et Total (vert/rouge selon le besoin). Absences pleine semaine, expirations d'habilitation et fins de contrat déduites. Bascule habilitations strictes / ignorées.", garde: "matrice" },
];
