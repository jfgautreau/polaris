...
export const RAPPORTS_BILAN: RapportBilan[] = [
  ...
  { key: "bilan:polyvalence", slug: "polyvalence", href: "/bilans/polyvalence", ic: "🎯", t: "Polyvalence & compétences", d: "Compétence moyenne par service, postes fragiles, écarts cible, habilitations.", garde: "matrice" },
  { key: "bilan:montee-competence", slug: "montee-competence", href: "/bilans/montee-competence", ic: "📈", t: "Plan de montée en compétence", d: "Actuel vs cible en global, puis qui former sur quel poste, service par service.", garde: "matrice" },
